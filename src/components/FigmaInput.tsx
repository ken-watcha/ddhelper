    ...
    <section className="bg-[#141414] rounded-2xl p-6 md:p-8 border border-white/[0.06] h-full flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <button
          ...
          className="px-6 py-3 bg-white text-black rounded text-[13px] font-bold hover:bg-neutral-100 active:bg-neutral-200 disabled:opacity-40 disabled:cursor-not-allowed whitespace-nowrap transition-colors flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
